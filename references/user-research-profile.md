...
## Feedback 2026-06-25 17:20

- Topic: 学理性实操机制
- Feedback: 学理性应从定位、提炼、建构、批判、抽象五个动作进入写作；论文要知道自己处于哪个学科或子领域，与哪些理论问题对话；现象要被提炼为学术问题；理论框架要能解释对象，对象也要反过来丰富理论；批判要温和地指出已有研究的范围和不足；案例、政策、文本和经验材料最终要上升为可迁移的机制或理论洞见。纯理论思辨论文的质感来自概念辨析、论证层次、汉语节制、文献对话和标题逻辑。
- Action: 新增 `scholarliness-protocol.md`，把学理性拆成学术地图、问题提炼、概念台账、框架一致性、文献对话、批判判断和理论抽象。注意：材料中出现的公式化句式和夸张动词仅作为辨析对象，仍服从 17:05 已确认的反机器腔禁令。

## Feedback 2026-06-25 17:35
