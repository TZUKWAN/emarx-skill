...
v7.1 增加小节准入证据：完整论文审稿前必须先检查每个正文二级小节是否有小节论证卡、文献功能绑定和 `section_quality_gate.py` 输出。任一小节未过门，整篇文章不能进入最终审稿，只能回到对应小节重写。
...
- 每个二级小节是否都有独立论证任务、承接关系和判断落点，而不是把一级标题拆成清单？
- 每个二级小节是否保存了对应小节质量门结果，且没有被带着失败问题并入全文？
...
- 小节级质量门是否已经阻断“本文认为”“有研究指出”“首先其次”“并非而是”“重构”“应当加强”“推动促进提升赋能”等惯性表达，而不是把这些问题留给全文润色？
