...
- `references/material-anchoring-protocol.md`: section-level and evidence-paragraph anchoring, local-source coverage table, interactive diagnosis card, and plain-language structure discipline.
