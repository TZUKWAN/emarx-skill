...
EMARX 是一个面向 Codex 的中文学理思辨论文生产系统。v4 版本的重点不再只是“把论文写得更像论文”，而是建立一套完整流程：本地资料优先读取、资料建档、研究逻辑梳理、创新点分析、初稿写作、大家风范语体校准、匿名评审式审稿、改稿深化、事实核查、Word 交付，以及用户研究画像迭代。
...
EMARX v4 继承并尊重此前全文蒸馏形成的写作规律。该批材料的已验证记录为：
...
`references/distillation-evidence.md` 中保留了标题、摘要、引言、正文结构、段落模板、文风控制、审稿规则等从真实文献中提炼出的规律。v4 的新流程是在这些规律之上搭建，而不是替代它们。

## 大家风范语体

EMARX v4 的目标语言不是晦涩的“学术腔”，也不是普通评论式白话，而是：
