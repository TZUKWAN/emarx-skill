...
EMARX 是一个面向 Codex 的中文学理思辨论文生产系统。v6.8 版本的重点不再只是“把论文写得更像论文”，而是建立一套完整流程：当前工作空间资料优先读取、三至五篇真实论文锚定、锚定论文即时拆解、内部影子重组、逻辑骨架生成、段落级详细大纲、逐段写作、无主语摘要校准、反“本文腔”和反综述插入审查、结构防火墙、大家风范语体校准、匿名评审式审稿、改稿深化、事实核查、Word 交付，以及用户研究画像迭代。
...
- 本地资料优先，不再凭空写作
- 锚定必须从用户当次工作空间里的真实论文文件开始
- 可用既有拆解报告作为缓存，但不能从旧报告库替代当次锚定
- 根据用户题目从当前工作空间锚定 3-5 篇论文后，必须即时拆解这些锚定论文
- 即时拆解内容包括摘要逻辑、引言、主体、结论、文风、写作手法和论证方式
- 支持内部影子重组，用来学习结构、逻辑和段落功能，但不能作为最终论文交付
- 正式写作前必须形成段落级详细大纲，写作时一段一段推进
- 必要时再联网检索，补充最新政策、数据、法规、文献和事实
- 写作前必须形成研究简报与问题诊断
- 完整论文默认正文 10,000-12,000 字，不再把短篇聊天文本伪装成论文
- 正文主体必须有二级标题，默认使用“一、”“（一）”的中文学术层级
- 新增结构防火墙，禁止把“研究对象与概念边界”“理论框架”“问题诊断”“路径建设与可执行条件”等内部流程写成论文标题
- 一级标题必须呈现论证对象、功能、机制、风险、转化或路径，不能只是研究流程标签
...
- 全量重跑 450 篇可读论文的语言表达蒸馏，新增 `references/language-expression-distillation-v68.md`
- 摘要默认采用无作者主语、面向对象的报道式写法，禁止用“本文”“笔者”“本研究”说明自己在写什么
- 正文禁止“本文认为”“本文的核心观点是”“文章认为”“文章指出”等论文自我说明
- 文献必须被消化进概念、机制、问题或限制，禁止用“有研究指出”“已有研究认为”“相关研究指出”等综述插入句堆文献
- 标点保持克制，避免“问题在于：”“核心观点是：”等冒号小标题腔、装饰性引号和破折号式 AI 腔
...
EMARX v6.8 继承并尊重此前全文蒸馏形成的写作规律。该批材料的已验证记录为：
...
`references/distillation-evidence.md` 中保留了标题、摘要、引言、正文结构、段落模板、文风控制、审稿规则等从真实文献中提炼出的规律。v6.8 的新流程是在这些规律之上搭建，而不是替代它们。
...
因此，EMARX 把“10,000-12,000 字正文”和“正文主体必须有二级标题”写成硬规则。v6.5 进一步要求标题层级必须是论文的论证骨架，而不是内部研究流程。v6.7 增加当前工作空间真实论文锚定、锚定论文即时拆解、影子重组和逐段写作流程。v6.8 进一步把语言表达蒸馏写入技能：摘要不再自称“本文”，正文不再解释“文章要做什么”，文献不再用“有研究指出”式综述插入，而要进入论文自己的论证运动。此前没有二级标题、篇幅过短、把诊断项写成章节标题、从旧报告库替代当次锚定、一次性生成多段后再泛泛润色，或者出现明显自我说明腔和综述插入腔的输出，均视为不合格。
...
蒸馏结果保存在 `references/language-expression-distillation-v68.md`。需要注意，336 篇摘要为基于首页文本的推断摘要，受 PDF 抽取和元数据干扰影响，只作为辅助证据；显式摘要和用户反馈才是本轮语言规则的核心依据。

## 大家风范语体

EMARX v6.8 的目标语言不是晦涩的“学术腔”，也不是普通评论式白话，而是：
